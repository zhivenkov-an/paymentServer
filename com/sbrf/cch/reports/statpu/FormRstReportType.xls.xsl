...
<xsl:template match="bik|corr_acc|settle_acc|special_client_code|osb|filial|cashier|inn|receiver_name|service_channel_name|payment_means_name|transfer_date|payment_date" mode="spacing">
        <xsl:choose>
			...
			<xsl:when test="name() = 'inn'">
                <ss:Column ss:AutoFitWidth="0" ss:Width="100"/>
            </xsl:when>
			<xsl:when test="name() = 'receiver_name'">
                <ss:Column ss:AutoFitWidth="0" ss:Width="100"/>
            </xsl:when>			
...
<xsl:template match="bik|corr_acc|settle_acc|special_client_code|osb|filial|cashier|inn|receiver_name|service_channel_name|payment_means_name|transfer_date|payment_date" mode="head">
        <xsl:choose>
            <xsl:when test="name() = 'bik'">
                <ss:Cell ss:StyleID="theader">
                    <ss:Data ss:Type="String">
...
<xsl:template match="inn" mode="print">
    <xsl:param name="bik" select="''"/>
    <xsl:param name="settle_acc" select="''"/>
    <xsl:param name="special_client_code" select="''"/>
	<xsl:param name="osb" select="''"/>
    ...
    <xsl:choose>
        <xsl:when test="position() = 1">
            <xsl:apply-templates select="child::*" mode="print">
				...
				<xsl:with-param name="inn" select="@value"/>
            </xsl:apply-templates>
        </xsl:when>
        <xsl:otherwise>
            <xsl:apply-templates select="child::*" mode="print">
...
<xsl:template match="receiver_name" mode="print">
    <xsl:param name="bik" select="''"/>
    <xsl:param name="settle_acc" select="''"/>
    <xsl:param name="special_client_code" select="''"/>
	<xsl:param name="osb" select="''"/>
    ...
    <xsl:choose>
        <xsl:when test="position() = 1">
            <xsl:apply-templates select="child::*" mode="print">
				...
				<xsl:with-param name="receiver_name" select="@value"/>
            </xsl:apply-templates>
        </xsl:when>
        <xsl:otherwise>
            <xsl:apply-templates select="child::*" mode="print">
...
<xsl:template match="service_channel_name" mode="print">
	...
	<xsl:param name="cashier" select="''"/>
	<xsl:param name="inn" select="''"/>
	<xsl:param name="receiver_name" select="''"/>	
    ...
    <xsl:choose>
        <xsl:when test="position() = 1">
            <xsl:apply-templates select="child::*" mode="print">
				...
				<xsl:with-param name="cashier" select="$cashier"/>
				<xsl:with-param name="inn" select="$inn"/>				
				<xsl:with-param name="receiver_name" select="$receiver_name"/>								
...
<xsl:template match="item" mode="print">
    ...
    <ss:Row>
		...
		<xsl:if test="count(ancestor::inn) != 0">
            <ss:Cell ss:StyleID="string">
                <ss:Data ss:Type="String">
		...
		<xsl:if test="count(ancestor::receiver_name) != 0">
            <ss:Cell ss:StyleID="string">
                <ss:Data ss:Type="String">
...
<xsl:template match="items|bik|corr_acc|settle_acc|special_client_code|osb|filial|cashier|inn|receiver_name|service_channel_name|payment_means_name|payment_date|transfer_date" mode="summary_spacing">
