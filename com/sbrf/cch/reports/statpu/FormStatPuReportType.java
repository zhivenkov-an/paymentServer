package com.sbrf.cch.reports.statpu;
...
/**
 * отчет в разрезе поставщиков *.rst
 * @author Zhivenkov-AN
 *
 */
public class FormStatPuReportType extends AbstractSbtReportType implements ReportType, BillingPlugin {
    ...
    public FormStatPuReportType(Properties properties) {
        super(properties);
    ...
    public Parameter[] getParameters() throws ReportException {
        ...
        Parameter startDay = ParametersFactory.getOperDay().setDefault(startDate).setId("start_date").setDescription("Начальная дата(включительно)").setLabel("Начальная дата приёма");
        Parameter endDay = ParametersFactory.getOperDay().setDefault(endDate).setId("end_date").setDescription("Конечная дата(включительно)").setLabel("Конечная дата приёма");
        ...
        Parameter pOsb = new InputParameter("pOsb", "ОСБ").setDirectory("OSB_GROUP", "OSB_NUMB", "RECEIVER_NAME").setDescription("Принимает в качестве значения шаблон");
        ...
        Parameter groupByReceiver = new SelectParameter("groupByReceiver", "Группировать по ИНН?").setOptions(options);
        Parameter groupByReceiverName = new SelectParameter("groupByReceiverName", "Группировать по поставщикам?").setOptions(options);
        ...
        return super.getCommonParameters( startDay, endDay, payState, bik, corrAcc, settleAcc, inn, pOsb, groupByBik, groupBySettleAcc, groupByOSB, groupBySPC, groupByPaymentDate, groupByTransferDate, groupByServiceChannel, groupByPaymentMeans, groupByFilial, groupByCashier, groupByReceiver, groupByReceiverName);
    }
    ...
    public void prepareData(Map<Object, Object> inParameters, Map<Object, Object> outParameters, OutputStream data) throws InterruptedException, ReportException {
        ...
        try {
            ...
            boolean groupByReceiver = yesValue.equals( inParameters.get("groupByReceiver") );
            boolean groupByReceiverName = yesValue.equals( inParameters.get("groupByReceiverName") );
            ...
            if (groupByReceiver) {
                ...
                putOrderByComa = true;
                addOrderBy = addOrderBy + " INN";
                addFields = addFields + ", INN";
                fieldsList.add(new NameFieldDescription("INN"));
                groupedByXls = groupedByXls + "/ИНН получателя";
            }
            if (groupByReceiverName) {
                if (putOrderByComa) {
                    addOrderBy = addOrderBy + ",";
                }
                putOrderByComa = true;
                addOrderBy = addOrderBy + " RECEIVER_NAME";
                addFields = addFields + ", RECEIVER_NAME";
                fieldsList.add(new NameFieldDescription("RECEIVER_NAME"));
                groupedByXls = groupedByXls + "/Наименование получателя";
            }
    ...
    private final static class Config {
        ...
        public Config(PluginConfigurationHelper context) {
            ...
            this.sqlQueryPath = context.getString(ReportSettingNames.SQL_QUERY_PATH, "/com/sbrf/cch/reports/statpu/FormStatPuReportType.sql");
            ...
            this.excellStylePath = context.getString(ReportSettingNames.XLS_STYLE_PATH, "/com/sbrf/cch/reports/statpu/FormRstReportType.xls.xsl");
    ...
    private static final class ConditionsDAO extends AbstractDAO {
        ...
        public String makeSQLConditions(Map<Object, Object> inParameters) {
            ...
            String pOsb = (String) inParameters.get("pOsb");
            ...
            makeStringCondition("OSB", pOsb, sqlGen);
