...
<xsl:template match="bik|corr_acc|settle_acc|special_client_code|osb|transfer_date|payment_date" mode="spacing">
        <xsl:choose>
...
<xsl:template match="bik|corr_acc|settle_acc|special_client_code|osb|transfer_date|payment_date" mode="head">
        <xsl:choose>
            <xsl:when test="name() = 'bik'">
                <ss:Cell ss:StyleID="theader">
                    <ss:Data ss:Type="String">
...
<xsl:template match="items|bik|corr_acc|settle_acc|special_client_code|osb|payment_date|transfer_date" mode="summary_spacing">
